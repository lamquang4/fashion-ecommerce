      ...
      {totalItems > 0 && (
        <div className="flex items-center justify-center bg-white px-[15px] py-3 w-full flex-wrap gap-5 sm:gap-3 text-[0.9rem]">
          <nav className="isolate inline-flex gap-2">
            <button
              type="button"
              className="h-8.5 w-8.5 inline-flex justify-center items-center gap-x-2 text-[0.9rem] rounded-full border text-gray-800"
              aria-label="Previous"
              title="Previous"
              ...
              if (page === "...") {
                return (
                  <button
                    ...
                    disabled
                    key={`ellipsis-${index}`}
                    className="group h-8.5 border w-8.5 flex justify-center items-center text-gray-800 rounded-full text-[0.9rem]"
                  >
                    ...
                  </button>
                );
