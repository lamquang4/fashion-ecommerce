...
const MenuSide: React.FC<MenuMobileProp> = ({ isOpen, toggleMenu }) => {
  ...
  return (
    <>
      <nav
        className={`fixed lg:static top-0 w-full max-w-[350px] h-screen p-5 bg-white shadow-md overflow-hidden overscroll-contain transition-all duration-500 ease-in-out z-[22] ${
