...
function SizeChartModal({ sizes, isOpen, onToggleMenu }: props) {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 z-20 h-full custom-scroll overflow-y-auto overflow-x-hidden">
      <div className="sm:p-[15px] flex justify-center items-center">
        <div className="relative w-full max-w-[720px] max-h-full">
          <div className="relative sm:p-[25px_20px] p-[25px_15px] bg-white z-20 space-y-[15px] sm:rounded-lg">
            <div className="flex items-center justify-between">
              <h4 className="uppercase truncate">Hướng dẫn chọn kích thước</h4>
              ...
              <div className="grid gap-[15px] sm:grid-cols-2 grid-cols-1">
                <div className="space-y-[10px]">
                  ...
                  <p className="font-normal">
                    Đo tại phần đầy nhất của vòng ngực, giữ thước dây song song
                    với mặt đất.
                  </p>
                  ...
                  <p className="font-normal">
                    Đo tại phần đầy nhất của vòng mông, giữ thước dây song song
                    với mặt đất.
                  </p>
                </div>
